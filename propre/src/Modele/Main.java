...
public class Main { // Main à lancer pour le jeu en console
	...
	public static void main(String[] args) {
		...
		while (Ma.P.verifierFinPartie()) {
			...
			int i1 = 0;
			while (Ma.P.joueur.get(i1).hand.mainVide()) {
				...
				System.out.println(
						"Main joueur " + Ma.M.joueur.get(i1).getNom() + " : " + Ma.M.joueur.get(i1).hand.getCarte());
